...
Разрабатываю и документирую конфигурации для игр и настройки ОС. Мой проект **ALL-GAMES**, также веду [WIKI](https://github.com/Etozheesusoff/ALL-CONFIGS/wiki) — это структурированная база знаний с пошаговыми инструкциями.
